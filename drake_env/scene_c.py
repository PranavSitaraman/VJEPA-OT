...
def generate_scene_c_episode(
    ...
    **kwargs,
    ...
    """
    Generate Scene C episode: letter A manipulation on shelf.
    Same as Scene D but with letter A.
    ...
    # === Scene C Planning (same as D, different letter) ===
    ...
    # === Scene C Configuration ===
    # Prepare scenario YAML with letter A
...
__all__ = ["generate_scene_c_episode"]

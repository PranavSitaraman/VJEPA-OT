...
def generate_scene_a_episode(
    ...
    **kwargs,
    ...
    """
    Generate Scene A episode: letter P manipulation on shelf.
    Same as Scene D but with letter P and slightly different positions.
    ...
    # === Scene A Planning (same as D, different letter) ===
    ...
    # === Scene A Configuration ===
    # Prepare scenario YAML with letter P
...
__all__ = ["generate_scene_a_episode"]
